# huangzhenjun<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>黄振俊 生日快乐</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        @keyframes glow {
            ...
            to { filter: drop-shadow(0 0 40px rgba(255, 255, 255, 1)) drop-shadow(0 0 60px rgba(255, 215, 0, 0.8)); }
        }
        ...
        @media (max-width: 768px) {
            ...
            .name { font-size: 40px; letter-spacing: 5px; }
            .wish { font-size: 30px; }
...
<body>
    ...
    <div class="login-container" id="loginContainer">
        <div class="login-box">
            ...
            <button class="login-btn" onclick="checkLogin()">确定</button>
            
            <p class="error-message" id="errorMsg">用户名或密码错误，请重试！</p>
        </div>
    </div>
    ...
    <script>
        // 正确的用户信息
        const CORRECT_USERNAME = "黄振俊";
        const CORRECT_PASSWORD = "0220";
        ...
        function initFireworks() {
            ...
            canvas.addEventListener('touchstart', (e) => {
                ...
                const color = getRandomColor();
                fireworks.push(new Firework(touch.clientX, canvas.height, touch.clientY, color));
            });
        }
        ...
        console.log('🎆 登录成功后，点击屏幕任意位置可以发射更多烟花！');
    </script>
</body>
</html>
